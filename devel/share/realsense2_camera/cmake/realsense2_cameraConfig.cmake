...
if(NOT "/home/robot/catkin_view/devel/include " STREQUAL " ")
  set(realsense2_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/robot/catkin_view/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense2_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/catkin_view/src/realsense-ros/realsense2_camera/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robot/catkin_view/devel/lib;/opt/ros/noetic/lib)
